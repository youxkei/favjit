...
pub use region::{passed_down as trace_descriptor, Region};
pub use repeat::{hid_systems, Parameters, System, Systems};
pub use supervisor::{do_not_block, named_fd as supervisor_descriptor, Supervisor};
...
impl SinkInputHost for MacOsHost {
    ...
    fn start_a_clock(&mut self) {
        self.clock = capture::Clock::start();
    }
}
