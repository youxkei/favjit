...
/// tables in `engine`'s layout module can be read against the Karabiner
/// configuration they were ported from.
...
impl Key {
    ...
    /// two things that need to — a trace's numbering and a host's table walk —
    /// both need the whole set or they are checking a subset and saying nothing
    /// about the rest.
    ///
