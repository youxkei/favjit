# Install into an ad hoc signed application bundle and ask for Accessibility in the user's session

- **Date**: 2026-08-29

The finding it rests on is [input permissions](input-permissions.md), and what it
puts in place is [the daemon install's](install-as-a-daemon-and-turn-off-with-a-file.md).
...
([the daemon install](install-as-a-daemon-and-turn-off-with-a-file.md)).
